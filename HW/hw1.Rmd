...
The last line
corresponds to creating a linear model in which y is
...
x1 and x2. Describe the results obtained. What are ˆ B0, ˆ B1, and
ˆ B2? How do
these relate to the true B0, B1, and B2? Can you reject the null hypothesis H0 :
B1 = 0? How about the null hypothesis H0 : B2 = 0?
...
Comment on
your results. Can you reject the null hypothesis
H0 : B1 = 0?
